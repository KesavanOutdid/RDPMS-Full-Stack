                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-6">
                        <div className="small-box bg-success">
                            ...
                            </div><Link className="small-box-footer" id="view-active" onClick={() => handleClickAct(data)}>View <i className="fas fa-arrow-circle-right"></i></Link>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        {loading ? (
                                            ...
                                            posts.map((dataItem, index) => (
                                                ...
                                                <td>
                                                    <Link to={`/trackhmuhistory/?device_name=${dataItem.device_id}&&module=${dataItem.module_name}`}>
