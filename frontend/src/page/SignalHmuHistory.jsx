                                ...
                                <tbody>
                                    {loading ? (
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>{dataItem.currentChannels_i1}</td>
                                            <td>{dataItem.currentChannels_i1}</td>
                                            {dataItem.localsignalstatus_status === 1 ? <td><span className="badge bg-success">Active</span></td> : <td><span className="badge bg-danger">Inactive</span></td>}
                                        </tr>
                                          ))
                                        ) : (
                                          <tr>
                                ...
                                {loading ? (
                                    <tr>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>{historyDataItem.VoltageChannels_v2}</td>
                                            <td>{historyDataItem.VoltageChannels_v3}</td>
                                            {historyDataItem.localsignalstatus_status === 1 ? <td><span className="badge bg-success">Active</span></td> : <td><span className="badge bg-danger">Inactive</span></td>}
                                        </tr>
                                        ))
                                    ) : (
                                        <tr>
